...
const menuOptions = [
  ...
  { icon: <Settings className="w-4 h-4 mr-2" />, text: "Billing and subscription ", href: " /dashboard/settings" },
  ...
  return (
    <div className="flex items-center justify-end px-6 py-4 bg-white dark:bg-background relative">
      <div className="flex items-center cursor-pointer select-none" onClick={() => setOpen(!open)}>
        ...
        <div className="h-8 w-8 rounded-full bg-[#ffd404] flex items-center justify-center text-white mr-2">J</div>
