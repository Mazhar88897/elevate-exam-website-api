        ...
        questionsData.chapters.forEach(chapter => {
          chapter.subtopics.forEach(subtopic => {
            subtopic.questions.forEach(apiQuestion => {
              ...
              let status: QuestionStatus = "skipped" // Default to skipped
              ...
              transformedQuestions.push({
                ...
                status,
                category: typeof window !== 'undefined' ? sessionStorage.getItem('course_name') || "" : "",
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-start mb-8">
          ...
          <div className="mb-6 md:mb-0 md:max-w-[60%]">
            ...
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">
             {typeof window !== 'undefined' ? sessionStorage.getItem('course_name') || '' : ''} Quiz.
            </h2>
