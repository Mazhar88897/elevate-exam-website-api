  ...
  return (
    <div className="border-b border-black py-3">
      <div className="flex items-baseline gap-1">
        <span className="text-xl lg:text-2xl font-bold text-slate-700 ">{number}</span>
  ...
  return (
    <section className="py-16 px-8 ">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="py-3 flex flex-wrap  justify-left  w-full gap-8">
     
        <HoverCard width={300} height={340} className="p-4">
          <CourseCard
        ...
        <div className="space-y-8  ml-2  lg:ml-10 ">
          <div>
